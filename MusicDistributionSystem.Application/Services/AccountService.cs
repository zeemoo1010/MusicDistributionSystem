    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<AuthResultDto> RegisterAsync(RegisterRequestDto request)
        {
            ...
            if (existingUser is not null)
            {
                ...
                {
                    await SendFreshTokenAsync(existingUser, AccountTokenType.EmailVerification);
                    await _appLogger.LogInformationAsync("Account", $"Fresh verification code sent for existing unverified email '{normalizedEmail}'.");
