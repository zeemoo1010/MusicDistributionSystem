        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyDownloadLimit = table.Column<int>(type: "int", nullable: false),
                    HasAdFreeExperience = table.Column<bool>(type: "bit", nullable: false),
                    HasPriorityReview = table.Column<bool>(type: "bit", nullable: false),
                    HasArtistPromotionTools = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipTier = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicTracks_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownloaderIpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DownloadRecords_MusicTracks_MusicTrackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTokens_UserId_Type_ConsumedAtUtc",
                table: "AccountTokens",
                columns: new[] { "UserId", "Type", "ConsumedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DownloadRecords_MusicTrackId",
                table: "DownloadRecords",
                column: "MusicTrackId");

            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_CategoryId",
                table: "MusicTracks",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_UploadedByUserId",
                table: "MusicTracks",
